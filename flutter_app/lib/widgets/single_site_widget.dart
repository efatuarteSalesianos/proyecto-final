...
class SingleSite extends StatefulWidget {
  final SiteResponse? site;

  const SingleSite({Key? key, this.site}) : super(key: key);

  @override
  State<SingleSite> createState() => _SingleSiteState();
}

class _SingleSiteState extends State<SingleSite> {
  @override
  void initState() {
